...
def main():
    ...
    parser.add_argument('--noise_ratio', type=float, default=0.3,help='ratio of anomalies')
    parser.add_argument('--noise_type', type=str, default='const',help='type of anomalies [none,const,missing,gaussian]')
